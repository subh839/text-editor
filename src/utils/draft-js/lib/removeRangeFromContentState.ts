...
var getNextDelimiterBlockKey = require('draft-js/lib/getNextDelimiterBlockKey');
...
var getNextDelimitersBlockKeys = function getNextDelimitersBlockKeys(
  block,
  blockMap
) {
  var nextDelimiters = [];
...
var getNextValidSibling = function getNextValidSibling(
  block,
  blockMap,
  originalBlockMap
) {
...
var getPrevValidSibling = function getPrevValidSibling(
  block,
  blockMap,
  originalBlockMap
) {
...
var updateBlockMapLinks = function updateBlockMapLinks(
  ...
  return blockMap.withMutations(function(blocks) {
    ...
    getAncestorsKeys(startBlock.getKey(), originalBlockMap).forEach(function(
      parentKey
    ) {
    ...
    getAncestorsKeys(endBlock.getKey(), originalBlockMap).forEach(function(
      parentKey
    ) {
    ...
    getNextDelimitersBlockKeys(endBlock, originalBlockMap).forEach(function(
      delimiterKey
    ) {
